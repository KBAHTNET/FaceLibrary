...
namespace CustomDesign
{
    public class CustomButton : Control
    {
        ...
        private Color colorHover=  Color.FromArgb(80,255,100,0);
        [DisplayName("FillColor")]
        [Description("Цвет, в который кнопка закрашивается при наведении")]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            graph.FillRectangle(new SolidBrush(colorHover), rectCurtain);
