...
namespace CustomDesign.Components
{
    public partial class CustomFormStyle : Component
    {
        #region -- Свойста --
        ...
        public BorderHoverPositionEnum BorderHoverPosition = BorderHoverPositionEnum.None;
        public enum BorderHoverPositionEnum
        {
            None, // Не наведен
        ...
        public CustomFormStyle()
        {
            InitializeComponent();
        }
        public CustomFormStyle(IContainer container)
        {
            container.Add(this);
